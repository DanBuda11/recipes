export default [
  ...
  },
  {
    ...
    steps: [
      'Set InstantPot to sauté at high heat. Add 1 Tbsp oil. Add shrimp and season with 1 tsp Creole seasoning, 1/2 tsp salt and several grinds of pepper. Cook and toss just until the shrimp turn pink, about 1 minute. Transfer to a plate.',
    ...
    course: 'instantpot',
    notes:
      'May need to add water to pot to make sure enough steam created and InstantPot doesn\'t give "Food Burn" warning. Also may want to add more salt than recipe suggests.',
  },
  {
    name: 'Brunswick Stew',
    id: '184',
