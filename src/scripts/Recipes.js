export default [
  ...
  },
  {
    ...
    steps: [
      'Heat a large Dutch oven over medium heat. Coat pan with cooking spray. Add chopped onion and beef to pan. Cook 10 minutes or until onion is tender & beef is browned, stirring occasionally.',
  ...
  {
    name: 'White Bean & Chicken Green Chili',
    id: '18',
    description: '',
    ingredients: [
      '6 Anaheim chiles',
    ...
    steps: [
      ...
      'Spoon about 1 1/2 cups soup into each of 6 bowls. Serve with lime slices',
    ],
    image: 'no-photo.png',
    course: 'soups',
    notes: '',
  ...
  {
    name: 'Salmon Cakes with Corn & Avocado Salsa',
    id: '47',
    description: '',
    ingredients: [
      '1 can salmon',
    ...
    steps: [
      'Heat a large nonstick skillet over medium heat. Coat pan with oil. Add bell pepper to pan; saute 3 minutes. Add garlic; saute for 1 minute. Remove from heat. Place mixture in a large bowl.',
      'To the bowl, add salmon, green onions, mayonnaise, 1 Tbsp lime juice, hot sauce, 1/4 tsp salt and egg, stirring well. Stir in half the cilantro and 1/4 cup panko.',
      'Divide salmon mixture into 6-7 equal portions, shaping each into a 1/2-inch thick patty. Dredge both sides of patties in remaining 1/2 cup panko. Chill at least one hour.',
      'Heat pan over medium-high heat. Coat pan with oil. Add cakes to pan; cook 4 minutes on each side or until browned.',
      'To prepare salsa, combine remaining ingredients and stir gently to mix. Serve immediately with cakes.',
    ],
    image: 'shrimp-cakes.png',
    course: 'entree',
    notes: 'Can substitute avocado for the mayonnaise.',
  },
  {
    name: 'Taco Seasoning',
    id: '48',
  ...
  },
  {
    ...
    ingredients: [
      ...
      '3-4 carrots, chopped',
      '1 russet or 2 red potato(es), chopped',
    ...
    steps: [
      'Add all ingredients to slow cooker and cook on high 4-6 hours until vegetables soft.',
    ],
    image: 'no-photo.png',
    course: 'crockpot',
    notes:
      'Can add 2-3 chicken breasts and swap vegetable broth for chicken broth. Once soup is done cooking, remove chicken and shred; add back to soup and mix through before serving.',
  },
  {
  ...
  },
  {
    ...
    ingredients: [
      ...
      '1-2 red chiles (sliced), or 1/2 tsp dried crushed chili, or 1-2 tsp chili sauce',
  ...
  },
  {
    ...
    steps: [
      'Wash and dry 1 wide-mouth quart or 2 wide-mouth pint jars and lids.',
      'Rinse and drain beans well. Trim stem ends and cut to be slightly shorter than jar height.',
      'Place peeled garlic cloves, pepper flakes, and mustard seeds in the jar(s).',
      'Place the jar(s) on its side. Place dill sprigs down first then stack the beans in the jar, orienting them so they will stand up straight when the jar(s) stands upright. Pack jar(s) as tightly as possible.',
      'Bring vinegar, water and salt to a boil in a small saucepan over high heat. Pour brine over the beans, filling each jar to within 1/2" of the top. You may not use all the brine.',
      'Gently tap the jar(s) against the counter a few times to remove any air bubbles. Top off with more brine if needed. Screw lids on tight.',
      'Let the jar(s) cool to room temperature. Store pickles in the refrigerator. Pickles will improve flavor over time. Try not wait at least 48 hours before opening.',
    ],
    image: 'no-photo.png',
    course: 'pickles',
    notes: '',
  ...
  {
    name: 'Perfect Baked Chicken Breast',
    id: '159',
    description: '',
    ingredients: ['Chicken breast', 'Salt', 'Preferred seasoning'],
    steps: [
      'Preheat oven to 450',
  ...
  {
    name: 'Roasted Shrimp with Okra and Tomatoes',
    id: '160',
    description: '',
    ingredients: [
      ...
      'Salt & black pepper',
      '1/4 cup olive oil',
      '1 lb small to medium okra, trimmed',
  ...
  },
  {
    ...
    steps: [
      'Slice jalapenos thin. Slice off top of bell pepper and remove seeds and membranes then chop.',
      "Combine peppers and garlic in a 28-oz or larger glass jar. In a small saucepan, combine vinegar, water, salt. Bring close to a boil, stirring occasionally to dissolve salt into liquid. Remove from heat and pour over the peppers. Use a butter knife to poke down the peppers so they all fit and there aren't any hidden air pockets.",
  ...
  },
  {
    ...
    ingredients: [
      ...
      'Two 32-oz containers plain Greek yogurt',
      '8 Tbsp honey',
...

  {
    ...
    ingredients: [
      'Preferred seasoning',
      '4 bone-in chops, about 1 1/2 inches thick',
      '4 Tbsp olive oil',
    ],
    steps: [
      'Preheat oven to 400 and grease a baking pan with oil or line it with parchment paper.',
      'Place chops on the pan and drizzle with oil, then rub or brush oil on both sides of chops.',
  ...
  {
    name: 'Cuban Baked Chicken with Yellow Rice',
    id: '166',
    description: '',
    ingredients: [
  ...
  },
  {
    ...
    steps: [
      'Combine the cereal, melba toast, Parmesan, parsley, paprika and 1/2 teaspoon salt in a large resealable bag and, using the bottom of a skillet or rolling pin, crush into a coarse meal. Dump out into a shallow dish. Whisk the egg whites with 2 tablespoons water in another shallow dish. ',
  ...
  },
  {
    name: 'Banana Bread',
    id: '168',
    description: "Grandma Boyer's recipe.",
    ingredients: [
      '1 stick butter or 6 Tbsp oil',
      '1 cup sugar (can reduce by 1/4 cup)',
      '2 eggs (or 4 whites, or 1/2 cup egg beaters)',
      '2 cups white flour (or 1 1/2 cup white and 1/2 cup wheat)',
      '1 tsp baking soda',
      '1 Tbsp lemon juice',
    ...
    steps: [
      ...
      'Stir flour and soda together. If using, stir in cinnamon and flax.',
      'Add the dry mixture to the creamed mixture.',
      'Add lemon juice, nuts and mashed bananas. Mix only until batter is lumpy.',
      'Pour batter into greased 9x5x3 loaf pan.',
      'Bake for 50-60 minutes or until toothpick inserted into center comes out clean.',
      'Cool in pan 10 minutes then remove loaf and cool on a rack.',
    ],
    image: 'no-photo.png',
    course: 'baking',
    notes: '',
  },
  {
    ...
    steps: [
      'Combine flour and salt and stir well.',
      'In a liquid measuring cup, combine the oil and water and stir quickly together.',
      'Add oil and water mixture to flour mixture and stir together with a fork.',
      'Wet a cutting board with water. Place a piece of wax paper on the board. Place 1/2 the dough on the wax paper then cover with another piece of wax paper. Roll the dough out to about 1/2 inch thick and 1 inch wider than the pie pan. Peel off top wax paper and flip dough into pie pan.',
    ],
    image: 'no-photo.png',
    course: 'baking',
    notes: 'Makes 2 crusts.',
  },
  {
    name: 'Molasses Crinkle Cookies',
    id: '170',
    ...
    ingredients: [
      ...
      '1 tsp cinnamon',
      '1 tsp ginger',
      'White sugar for coating cookie dough',
    ],
    steps: [
      'In a large bowl, cream butter and sugar together until smooth. Add egg and mix thoroughly, then add molasses and mix again.',
      'Measure out flour and place in sifter. Add remaining dry ingredients to flour and sift.',
      'Add the sifted flour mixture to the butter mixture. Stir well until blended.',
      'Place dough into small bowl. Cover and chill.',
      'When ready to bake, preheat overn to 375.',
      'Roll dough into 1 1/2 inch balls and dip the tops in white sugar. Place balls sugar side up on a greased cookie sheet. Sprinkle each ball with 2-3 drops of water.',
      'Bake 10-12 minutes, or just until set, but not hard.',
    ],
    image: 'no-photo.png',
    course: 'baking',
    notes: '',
  },
  {
    ...
    steps: [
      ...
      'Grease a 12-cup muffin tin or line with baking cups.',
      'In a large bowl combine wheat bran, flour, baking soda, baking powder. Stir in nuts and raisins.',
      'In a separate bowl, combine applesauce, milk, molasses, oil and eggs. Add to dry ingredients and stir just until moistened. Spoon into muffin tin and bake 15-20 minutes, until tops are golden brown.',
    ],
    image: 'no-photo.png',
    course: 'baking',
    notes: '',
  },
  {
    ...
    steps: [
      'In small container, mix levain ingredients and keep in oven with light on for 5-6 hours.',
      'In medium mixing bowl, mix flour and 603g of the water. Cover and let rest 1 hour in oven with light on.',
      'To the mixing bowl holding the dough, add salt, ripe levain from Step 1, and up to remaining 50g water. Mix by hand or with a dough whisk until incorporated. Transfer dough to a bulk fermentation container and cover, continuing to keep in oven with light on.',
      ...
      'Starting 4 hours after the beginning of bulk fermentation, lightly flour your workspace and scrape out dough. Using bench knife, divide dough in half. Lightly shape each half into a round shape and let rest for 25 minutes, uncovered.',
  ...
  },
  {
    ...
    ingredients: [
      ...
      '2 Tbsp flour',
      '1 tsp cinnamon',
      'Apples, peeled and sliced (about 4 cups, or 2 lbs, or 6 apples',
      '1 Tbsp lemon juice',
      '2 Tsbp butter (can reduce or omit)',
      'Pie crust',
      'Milk',
    ],
    steps: [
      ...
      'Combine sugar, flour, and cinnamon. Spread half of this mixture over pie crust. Add apples to pie pan and sprinkle remained of sugar mixture over apples. Sprinkle with lemon juice. Roll, fit, and seal upper crust.',
      'Lightly brush milk on crust using pastry brush. Sprinkle sugar on crust.',
      'Bake for 30-40 minutes on lower oven shelf.',
    ],
    image: 'no-photo.png',
    course: 'desserts',
  ...
  },
  {
    ...
    ingredients: [
      ...
      '1 orange or yellow bell pepper, cut into 1" pieces',
      '1/2 yellow onion, cut into thin slices',
      '1 can baby corn, drained, cut into 1" long pieces',
      '1 package shiitake or other mushrooms, de-stemmed and cut into thin slices',
    ...
    steps: [
      'To make sauce, whisk together corn starch and water, then add broth, soy sauce, honey, sesame oil, red pepper flakes. Whisk together and set aside',
      'Add 1 Tbsp olive oil to a large skillet or wok and heat over medium-high heat. Add chicken and season with salt & pepper. Cook for 3-5 minutes or until cooked through. Remove from skillet and set aside.',
      'Reduce heat to medium and add remaining Tbsp olive oil.',
      'Add broccoli, bell pepper, onion & celery to pan, stirring occasionally, just until crisp tender.',
      'Add bok choy, baby corn, mushrooms and cook, stirring occasionally, until mushrooms are softened and boky choy has wilted.',
      'Add ginger and garlic and cook for an additional minute.',
      'Add chicken back to skillet and stir to combine.',
      'Whisk sauce and pour over chicken & veggies & stir gently to combine. Bring to a boil, stirring occasionally, and let boil 1 minute.',
      'Serve over rice.',
    ],
    image: 'no-photo.png',
    course: 'entree',
  ...
  },
  {
    ...
    description: '',
    ingredients: [
      '8-10 cups (1 lb) mixed greens (mesclun, mache, watercress, baby arugula, dandelion; include hydroponic lettuces, sprouts & shoots - pea shoots)',
  ...
  },
  {
    ...
    description: '',
    ingredients: [
      '2 cups unbleached flour, plus more for rollling berries',
      '1 Tbsp baking powder',
      '1 tsp salt',
      '1/3 cup sugar',
      '1/4 cup unsalted butter, chilled and cut in chunks, plus 2 Tbsp for glaze',
  ...
  },
  {
    ...
    steps: [
      'Peel and dice the mango or papaya, and put in a medium bowl. Trim the strawberriy stems and half or quarter, if large. Add to the bowl of fruit. Peel and dice the kiwi, add to bowl. Peel and slice the bananas, add to bowl.',
  ...
  },
  {
    ...
    steps: [
      ...
      'Melt the butter in a large cast-iron skillet over medium-high heat. Cook the sausage patties in two batches until the internal temperature reaches 160 degrees F, about 5 minutes per side.',
    ],
    image: 'no-photo.png',
    course: 'breakfasts',
    notes: '',
  },
  {
    ...
    ingredients: [
      ...
      '2 sticks) salted butter, melted and hot, plus 4 Tbsp salted butter, melted',
      '1/2 tsp kosher salt',
      'Pinch of black pepper',
      '1 Tbsp minced fresh chives, plus more chopped for serving',
    ...
    steps: [
      ...
      'For the hollandaise, dd the egg yolks and lemon zest and juice to a blender and blend for about 10 seconds. With the blender running, slowly drizzle in the 2 sticks melted butter. Season with the salt and pepper. Transfer to a serving vessel and stir in the minced chives, parsley and dill.',
      'Brush the bread with the remaining melted butter and place on the grill pan. Grill bread until nice grill marks form, about 1 minute per side. Set aside.',
      'To poach the eggs, begin by adding the vinegar to the large pot of simmering water. Gently crack the eggs into the water and leave them alone for 2 to 2 1/2 minutes. Remove the eggs with a slotted spoon and set aside on a paper lined plate so that any water is soaked up.',
      'To assemble, place a piece of bread on each of 4 plates and add a few slices of smoked salmon. Top with an egg, followed by some of the hollandaise. Garnish with chives.',
    ],
    image: 'no-photo.png',
    course: 'breakfasts',
    notes: '',
  ...
  {
    name: 'Various Oven Roasted Veggies',
    id: '182',
    description: '',
    ingredients: [
      'Asparagus, 425F for 12-15 minutes',
      'Broccoli, 400F for 15-22 minutes',
      'Cauliflower, 425F for 15-20 minutes',
      'Green Beans, 425F for 14-16 minutes',
      'Seasoning of choice',
      'Olive oil',
    ],
    steps: [
      'Preheat oven to correct temperature.',
      'Toss chosen veggie in olive oil and place in pyrex or other oven-safe dish. Coat with desired seasoning.',
  ...
  },
  {
    ...
    ingredients: [
      ...
      'Kosher salt & freshly ground black pepper',
      '8 oz andouille sausage, sliced into thin rounds',
      '1 lb boneless, skinless chicken thighs, trimmed of excess fat & cut into 1-inch chunks',
      '1 medium yellow onion, chopped',
    ...
    steps: [
      'Set Instant Pot to sauté at high heat. Add 1 Tbsp oil. Add shrimp and season with 1 tsp Creole seasoning, 1/2 tsp salt and several grinds of pepper. Cook and toss just until the shrimp turn pink, about 1 minute. Transfer to a plate.',
      'Add remaining oil to the pot. When oil is hot, add sausage and cook, tossing occasionally, until the edges start to brown, 1 to 2 minutes. Add chicken, onion, celery and bell pepper. Season with remaining 2 tsp Creole seasoning, 1 tsp salt and several grinds of black pepper. Cook, stirring occasionally, until vegetables wilt a bit, about 2 minutes. Add rice, broth, crushed tomato and tomato paste and stir well to combine.',
      'Turn off the sauté setting. Lock the lid and preparing to cook. Set to pressure cook on high for 9 minutes. After the pressure cook cycle is complete, quick release the lid and wait until the cycle is complete.',
      'Unlock and remove the lid. Stir in the shrimp. Put the lid on again. Let sit covered for 10 minutes. Uncover, stir in the parsley and scallions and serve.',
    ],
    image: 'no-photo.png',
    course: 'instantpot',
    notes:
      'May need to add water to pot to make sure enough steam created and Instant Pot doesn\'t give "Food Burn" warning. Also may want to add more salt than recipe suggests.',
  },
  {
    name: 'Brunswick Stew',
    id: '184',
    ...
    steps: [
      'Heat a large Dutch oven or soup pot over medium-high heat. Add enough olive oil to generously coat the bottom of the pot. Add the onion and season with salt and pepper. Cook, stirring occasionally, until the onions are soft, translucent and starting to brown at the edges, 12 to 15 minutes. Stir in the cayenne, and cook until fragrant, just a few seconds.',
      'Add the celery, and stir occasionally, until celery softens, 5 to 7 minutes.',
      ...
      'Remove the chicken from the pot, shred with two forks and return to the pot.',
    ],
    image: 'no-photo.png',
    course: 'soups',
    notes: 'Can add additional salt, pepper, cayenne or sugar to taste.',
  },
  {
    name: 'Pho',
    id: '185',
    ...
    ingredients: [
      ...
      '2 (2-inch pieces) fresh ginger, unpeeled and cut in half lengthwise',
    ...
    steps: [
      'Place a large dry pot over medium heat, and add onion and ginger. Cook 4 minutes, stirring occasionally.',
  ...
  {
    name: 'Corn & Poblano Chowder (Instant Pot)',
    id: '188',
    description: '',
    ingredients: [
    ...
    steps: [
      'Cut kernels from corn and set aside for now. Scrape corn again to get any remaining kernels & juices. Puree with 1 cup water and set aside.',
      'Turn Instant Pot to saute mode and heat oil. Add poblano, onion, jalapeno, celery. Mix well. Cook, covered with a glass lid, 4-5 minutes until onions turn translucent.',
      'Add potatoes, tomatoes, salt, allspice, corn kernels, pureed corn, and the remaining 1 cup water. Mixe well.',
      'Close Instant Pot with the pressure valve to sealing. Pressure cook 5 minutes. Natural release the pressure.',
      'Mix corn starch with 2 Tbsp water. Turn Instant Pot to saute mode and bring soup to a gentle boil. Stir corn starch nixture into the soup.',
      'Garnish with parsley and a sprinkle of cayenne.',
    ],
    image: 'no-photo.png',
    course: 'instantpot',
    notes: '',
  },
  {
    ...
    ingredients: [
      ...
      '1 1/2 lbs yukon gold potatoes, cut into 2 inch pieces',
      '2 Tbsp 2% milk',
    ...
    steps: [
      'Cook meat in a large, high-sided pan, breaking apart into small pieces until browned. Add a few pinches black pepper and pinch salt.',
      'To pan, add ⅔ of the rosemary and the beans. Cook, stirring occasionally, until beans start to turn brown and pop, about 8 minutes.',
      'To pan, add onions, carrots, celery and cook, stirring occasionally, 10 minutes.',
      'Add mushrooms and cook 5 minutes.',
      'Mix in flour and broth, bring to a boil, then simmer with a lid for 30 minutes.',
      'While meat mixture is simmering, add rutabaga to a large pan of boiling salted water. Cook 10 minutes then add potatoes and cook another 10 minutes.',
      'Drain the rutabaga & potato then mix in milk, half of the cheese, and salt & pepper to taste.',
      'Preheat oven to 350.',
      'Stir in 1 Tbsp Worcestershire sauce then taste and add more salt & pepper if needed.',
      'Pour the meat mixture into a 9”x13” casserole pan then cover with a layer of peas. Spoon the potato mixture on top of the peas, gently spreading it across the pan. With a fork, scuff up the potatoes making hills & valleys. Garnish the top of the potatoes with the remaining rosemary and cheese, and sprinkle with a little olive oil. Bake for 50 minutes or until potatoes turn golden on top.',
    ],
    image: 'no-photo.png',
    course: 'entree',
    notes: '',
  },
  {
    ...
    ingredients: [
      ...
      '1/2 cup cheese (cheddar, queso fresco, cotija)',
      '10oz ground beef or diced chicken (thigh or breast)',
      '1 poblano pepper, diced',
    ...
    steps: [
      'Heat a drizzle of oil in a large non-stick pan over medium-high heat. Add pepper and cook, stirring occasionally, until slightly softened, 2-3 minutes.',
      'Add meat and season with salt & pepper, and cook, stirring occasionally, until browned and cooked thru, 4-6 minutes.',
      'Stir in broth and cook until combined and less liquidy.',
      'Place tortillas on an open space and add meat & pepper mixture to one side of tortillas using a slotted spoon, then sprinkle with cheese and hot sauce to taste. Fold tortillas over.',
      'Drain any liquid out of the pan then place tortillas in pan and cook over medium heat 3-4 minutes per side.',
      'Cut avocado (if using) into cubes or slices and add to tops of tortillas with additional hot sauce if desired.',
    ],
    image: 'no-photo.png',
    course: 'entree',
    notes: '',
  ...
  },
  {
    ...
    ingredients: [
      ...
      '1/4 cup cilantro, chopped, plus more as a garnish',
      'Scallions, chopped',
      'Avocado, sliced',
    ...
    steps: [
      ...
      'Once oil is hot but not smoking, add onion, peppers, cumin and coriander. Cook, stirring constantly, until onion is translucent, 3-4 minutes.',
      'Stir in garlic and cook 30 seconds.',
      'Add quinoa, beans, corn, tomatoes, salt & pepper and stir in.',
      'Pour in liquid, secure the lid, and pressure cook on high 1 minute.',
      'When cooking is done, let pressure naturally release for 8-10 minutes, then vent the steam and remove the lid.',
  ...
  {
    name: 'Tomato Lentil Stew & Crispy Potato',
    id: '197',
    description: '',
    ingredients: [
      ...
      '1 tsp sugar',
      '1/2 tsp crushed red pepper',
      '2 small russet potatoes (about 12 oz)',
  ...
  },
  {
    ...
    steps: [
      'Heat oil or butter in a large pot over medium-high heat. Season beef with salt and pepper. Sear until deeply browned on all sides. Remove beef and set aside.',
      'Add mushrooms to the pot. Cook until browned. Add onions, garlic, tomato paste, and thyme. Stir constantly for 1 minute.',
      'Pour in Worcestershire sauce and a splash of broth. Scrape up the browned bits from the bottom of the pot.',
      'Return beef to the pot. Add potatoes and the rest of the broth. Bring to a boil, cover, and lower heat to a gentle simmer. Cook for 50-60 minutes until beef is tender.',
      'Scoop out 1 cup of the cooked potatoes and a splash of broth. Mash or blend them until smooth. Stir this purée back into the pot to instantly thicken the stew. Simmer for 5 more minutes.',
    ],
    image: 'no-photo.png',
    course: 'soups',
    notes: '',
